...
Public Class frmKasMasuk
    ...
    Private Sub frmKasMasuk_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim a As Integer
        For a = 1 To 12
            Dim b As String
            b = MonthName(a)
    ...
    Private Sub cmdPrint_Click(sender As System.Object, e As System.EventArgs) Handles cmdPrint.Click
        ...
        Dim rep As New CrystalReport5 'crJual merupakan nama file CrystalReport
        ...
        LapKasMasuk.CrystalReportViewer1.SelectionFormula = "{Table_Akun.Bulan}='" & bln & "' AND {Table_Akun.Tahun}='" & txtTahun.Text & "' AND {Table_Akun.Saldo_Kredit}<>0"
        ...
        LapKasMasuk.CrystalReportViewer1.ReportSource = rep
        'LapAktivitas.CrystalReportViewer1.RefreshReport()
        'LapAktivitas.CrystalReportViewer1.Refresh()
