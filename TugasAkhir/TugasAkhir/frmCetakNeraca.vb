...
Public Class frmCetakNeraca
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        ...
        Else
            ...
            tutupkoneksi()
            bukakoneksi()
            cmd = New SqlCommand("Select * from Table_Akun WHERE Tahun='" & txtTahun.Text & "'", conn)
            ...
            Else
                ...
                Dim i As Integer
                Dim debet1, debet2, debet3, debet4, debet5, debet6, debet7, debet8, debet9, debet10, debet11, debet12, debet13, debet14, debet15, debet16, debet18, debet19, debet20, debet21, debet22, debet23, debet24, debet28, debet29, debet30, debet31, debet32, debet33, debet34, debet35, debet65, debet66, debet67, debet68, debet69, debet70, debet71, debet72, debet73, debet75 As Integer
                Dim kredit1, kredit2, kredit3, kredit4, kredit5, kredit6, kredit7, kredit8, kredit9, kredit10, kredit11, kredit12, kredit13, kredit14, kredit15, kredit16, kredit18, kredit19, kredit20, kredit21, kredit22, kredit23, kredit24, kredit28, kredit29, kredit30, kredit31, kredit32, kredit33, kredit34, kredit35, kredit65, kredit66, kredit67, kredit68, kredit69, kredit70, kredit71, kredit72, kredit73, kredit75 As Integer
                ...
                Sql1 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun1 & "','" & Nama_Akun1 & "','" & Kelompok_Akun1 & "','" & Tahun1 & "','" & debet1 & "','" & kredit1 & "','" & header1 & "')"

                Sql2 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun2 & "','" & Nama_Akun2 & "','" & Kelompok_Akun2 & "','" & Tahun2 & "','" & debet2 & "','" & kredit2 & "','" & header2 & "')"

                Sql3 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun3 & "','" & Nama_Akun3 & "','" & Kelompok_Akun3 & "','" & Tahun3 & "','" & debet3 & "','" & kredit3 & "','" & header3 & "')"

                Sql4 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun4 & "','" & Nama_Akun4 & "','" & Kelompok_Akun4 & "','" & Tahun4 & "','" & debet4 & "','" & kredit4 & "','" & header4 & "')"

                Sql5 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun5 & "','" & Nama_Akun5 & "','" & Kelompok_Akun5 & "','" & Tahun5 & "','" & debet5 & "','" & kredit5 & "','" & header5 & "')"

                Sql6 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun6 & "','" & Nama_Akun6 & "','" & Kelompok_Akun6 & "','" & Tahun6 & "','" & debet6 & "','" & kredit6 & "','" & header6 & "')"

                Sql7 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun7 & "','" & Nama_Akun7 & "','" & Kelompok_Akun7 & "','" & Tahun7 & "','" & debet7 & "','" & kredit7 & "','" & header7 & "')"

                Sql8 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun8 & "','" & Nama_Akun8 & "','" & Kelompok_Akun8 & "','" & Tahun8 & "','" & debet8 & "','" & kredit8 & "','" & header8 & "')"

                Sql9 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun9 & "','" & Nama_Akun9 & "','" & Kelompok_Akun9 & "','" & Tahun9 & "','" & debet9 & "','" & kredit9 & "','" & header9 & "')"

                Sql10 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun10 & "','" & Nama_Akun10 & "','" & Kelompok_Akun10 & "','" & Tahun10 & "','" & debet10 & "','" & kredit10 & "','" & header10 & "')"

                Sql11 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun11 & "','" & Nama_Akun11 & "','" & Kelompok_Akun11 & "','" & Tahun11 & "','" & debet11 & "','" & kredit11 & "','" & header11 & "')"

                Sql12 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun12 & "','" & Nama_Akun12 & "','" & Kelompok_Akun12 & "','" & Tahun12 & "','" & debet12 & "','" & kredit12 & "','" & header12 & "')"

                Sql13 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun13 & "','" & Nama_Akun13 & "','" & Kelompok_Akun13 & "','" & Tahun13 & "','" & debet13 & "','" & kredit13 & "','" & header13 & "')"

                Sql14 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun14 & "','" & Nama_Akun14 & "','" & Kelompok_Akun14 & "','" & Tahun14 & "','" & debet14 & "','" & kredit14 & "','" & header14 & "')"

                Sql15 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun15 & "','" & Nama_Akun15 & "','" & Kelompok_Akun15 & "','" & Tahun15 & "','" & debet15 & "','" & kredit15 & "','" & header15 & "')"

                Sql16 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun16 & "','" & Nama_Akun16 & "','" & Kelompok_Akun16 & "','" & Tahun16 & "','" & debet16 & "','" & kredit16 & "','" & header16 & "')"

                'Sql17 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun17 & "','" & Nama_Akun17 & "','" & Kelompok_Akun17 & "','" & Tanggal_Input1 & "','" & Tahun17 & "','" & header17 & "','" & debet17 & "','" & kredit17 & "')"

                Sql18 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun18 & "','" & Nama_Akun18 & "','" & Kelompok_Akun18 & "','" & Tahun18 & "','" & debet18 & "','" & kredit18 & "','" & header18 & "')"

                Sql19 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun19 & "','" & Nama_Akun19 & "','" & Kelompok_Akun19 & "','" & Tahun19 & "','" & debet19 & "','" & kredit19 & "','" & header19 & "')"

                Sql20 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun20 & "','" & Nama_Akun20 & "','" & Kelompok_Akun20 & "','" & Tahun20 & "','" & debet20 & "','" & kredit20 & "','" & header20 & "')"

                Sql21 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun21 & "','" & Nama_Akun21 & "','" & Kelompok_Akun21 & "','" & Tahun21 & "','" & debet21 & "','" & kredit21 & "','" & header21 & "')"

                Sql22 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun22 & "','" & Nama_Akun22 & "','" & Kelompok_Akun22 & "','" & Tahun22 & "','" & debet22 & "','" & kredit22 & "','" & header22 & "')"

                Sql23 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun23 & "','" & Nama_Akun23 & "','" & Kelompok_Akun23 & "','" & Tahun23 & "','" & debet23 & "','" & kredit23 & "','" & header23 & "')"

                Sql24 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun24 & "','" & Nama_Akun24 & "','" & Kelompok_Akun24 & "','" & Tahun24 & "','" & debet24 & "','" & kredit24 & "','" & header24 & "')"

                'Sql25 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun25 & "','" & Nama_Akun25 & "','" & Kelompok_Akun25 & "','" & Tanggal_Input1 & "','" & Tahun25 & "','" & header25 & "','" & debet25 & "','" & kredit25 & "')"

                'Sql26 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun26 & "','" & Nama_Akun26 & "','" & Kelompok_Akun26 & "','" & Tanggal_Input1 & "','" & Tahun26 & "','" & header26 & "','" & debet26 & "','" & kredit26 & "')"

                'Sql27 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun27 & "','" & Nama_Akun27 & "','" & Kelompok_Akun27 & "','" & Tanggal_Input1 & "','" & Tahun27 & "','" & header27 & "','" & debet27 & "','" & kredit27 & "')"

                Sql28 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun28 & "','" & Nama_Akun28 & "','" & Kelompok_Akun28 & "','" & Tahun28 & "','" & debet28 & "','" & kredit28 & "','" & header28 & "')"

                Sql29 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun29 & "','" & Nama_Akun29 & "','" & Kelompok_Akun29 & "','" & Tahun29 & "','" & debet29 & "','" & kredit29 & "','" & header29 & "')"

                Sql30 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun30 & "','" & Nama_Akun30 & "','" & Kelompok_Akun30 & "','" & Tahun30 & "','" & debet30 & "','" & kredit30 & "','" & header30 & "')"

                Sql31 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun31 & "','" & Nama_Akun31 & "','" & Kelompok_Akun31 & "','" & Tahun31 & "','" & debet31 & "','" & kredit31 & "','" & header31 & "')"

                Sql32 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun32 & "','" & Nama_Akun32 & "','" & Kelompok_Akun32 & "','" & Tahun32 & "','" & debet32 & "','" & kredit32 & "','" & header32 & "')"

                Sql33 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun33 & "','" & Nama_Akun33 & "','" & Kelompok_Akun33 & "','" & Tahun33 & "','" & debet33 & "','" & kredit33 & "','" & header33 & "')"

                Sql34 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun34 & "','" & Nama_Akun34 & "','" & Kelompok_Akun34 & "','" & Tahun34 & "','" & debet34 & "','" & kredit34 & "','" & header34 & "')"

                Sql35 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun35 & "','" & Nama_Akun35 & "','" & Kelompok_Akun35 & "','" & Tahun35 & "','" & debet35 & "','" & kredit35 & "','" & header35 & "')"

                'Sql36 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun36 & "','" & Nama_Akun36 & "','" & Kelompok_Akun36 & "','" & Tanggal_Input1 & "','" & Tahun36 & "','" & debet36 & "','" & kredit36 & "','" & header36 & "')"

                'Sql37 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun37 & "','" & Nama_Akun37 & "','" & Kelompok_Akun37 & "','" & Tanggal_Input1 & "','" & Tahun37 & "','" & debet37 & "','" & kredit37 & "','" & header37 & "')"

                'Sql38 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun38 & "','" & Nama_Akun38 & "','" & Kelompok_Akun38 & "','" & Tanggal_Input1 & "','" & Tahun38 & "','" & debet38 & "','" & kredit38 & "','" & header38 & "')"

                'Sql39 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun39 & "','" & Nama_Akun39 & "','" & Kelompok_Akun39 & "','" & Tanggal_Input1 & "','" & Tahun39 & "','" & debet39 & "','" & kredit39 & "','" & header39 & "')"

                'Sql40 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun40 & "','" & Nama_Akun40 & "','" & Kelompok_Akun40 & "','" & Tanggal_Input1 & "','" & Tahun40 & "','" & debet40 & "','" & kredit40 & "','" & header40 & "')"

                'Sql41 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun41 & "','" & Nama_Akun41 & "','" & Kelompok_Akun41 & "','" & Tanggal_Input1 & "','" & Tahun41 & "','" & debet41 & "','" & kredit41 & "','" & header41 & "')"

                'Sql42 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun42 & "','" & Nama_Akun42 & "','" & Kelompok_Akun42 & "','" & Tanggal_Input1 & "','" & Tahun42 & "','" & debet42 & "','" & kredit42 & "','" & header42 & "')"

                'Sql43 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun43 & "','" & Nama_Akun43 & "','" & Kelompok_Akun43 & "','" & Tanggal_Input1 & "','" & Tahun43 & "','" & debet43 & "','" & kredit43 & "','" & header43 & "')"

                'Sql44 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun44 & "','" & Nama_Akun44 & "','" & Kelompok_Akun44 & "','" & Tanggal_Input1 & "','" & Tahun44 & "','" & debet44 & "','" & kredit44 & "','" & header44 & "')"

                'Sql45 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun45 & "','" & Nama_Akun45 & "','" & Kelompok_Akun45 & "','" & Tanggal_Input1 & "','" & Tahun45 & "','" & debet45 & "','" & kredit45 & "','" & header45 & "')"

                'Sql46 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun46 & "','" & Nama_Akun46 & "','" & Kelompok_Akun46 & "','" & Tanggal_Input1 & "','" & Tahun46 & "','" & debet46 & "','" & kredit46 & "','" & header46 & "')"

                'Sql47 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun47 & "','" & Nama_Akun47 & "','" & Kelompok_Akun47 & "','" & Tanggal_Input1 & "','" & Tahun47 & "','" & debet47 & "','" & kredit47 & "','" & header47 & "')"

                'Sql48 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun48 & "','" & Nama_Akun48 & "','" & Kelompok_Akun48 & "','" & Tanggal_Input1 & "','" & Tahun48 & "','" & debet48 & "','" & kredit48 & "','" & header48 & "')"

                'Sql49 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun49 & "','" & Nama_Akun49 & "','" & Kelompok_Akun49 & "','" & Tanggal_Input1 & "','" & Tahun49 & "','" & debet49 & "','" & kredit49 & "','" & header49 & "')"

                'Sql50 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun50 & "','" & Nama_Akun50 & "','" & Kelompok_Akun50 & "','" & Tanggal_Input1 & "','" & Tahun50 & "','" & debet50 & "','" & kredit50 & "','" & header50 & "')"

                'Sql51 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun51 & "','" & Nama_Akun51 & "','" & Kelompok_Akun51 & "','" & Tanggal_Input1 & "','" & Tahun51 & "','" & debet51 & "','" & kredit51 & "','" & header51 & "')"

                'Sql52 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun52 & "','" & Nama_Akun52 & "','" & Kelompok_Akun52 & "','" & Tanggal_Input1 & "','" & Tahun52 & "','" & debet52 & "','" & kredit52 & "','" & header52 & "')"

                'Sql53 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun53 & "','" & Nama_Akun53 & "','" & Kelompok_Akun53 & "','" & Tanggal_Input1 & "','" & Tahun53 & "','" & debet53 & "','" & kredit53 & "','" & header53 & "')"

                'Sql54 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun54 & "','" & Nama_Akun54 & "','" & Kelompok_Akun54 & "','" & Tanggal_Input1 & "','" & Tahun54 & "','" & debet54 & "','" & kredit54 & "','" & header54 & "')"

                'Sql55 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun55 & "','" & Nama_Akun55 & "','" & Kelompok_Akun55 & "','" & Tanggal_Input1 & "','" & Tahun55 & "','" & debet55 & "','" & kredit55 & "','" & header55 & "')"

                'Sql56 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun56 & "','" & Nama_Akun56 & "','" & Kelompok_Akun56 & "','" & Tanggal_Input1 & "','" & Tahun56 & "','" & debet56 & "','" & kredit56 & "','" & header56 & "')"

                'Sql57 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun57 & "','" & Nama_Akun57 & "','" & Kelompok_Akun57 & "','" & Tanggal_Input1 & "','" & Tahun57 & "','" & debet57 & "','" & kredit57 & "','" & header57 & "')"

                'Sql58 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun58 & "','" & Nama_Akun58 & "','" & Kelompok_Akun58 & "','" & Tanggal_Input1 & "','" & Tahun58 & "','" & debet58 & "','" & kredit58 & "','" & header58 & "')"

                'Sql59 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun59 & "','" & Nama_Akun59 & "','" & Kelompok_Akun59 & "','" & Tanggal_Input1 & "','" & Tahun59 & "','" & debet59 & "','" & kredit59 & "','" & header59 & "')"

                'Sql60 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun60 & "','" & Nama_Akun60 & "','" & Kelompok_Akun60 & "','" & Tanggal_Input1 & "','" & Tahun60 & "','" & debet60 & "','" & kredit60 & "''" & header60 & "',)"

                'Sql61 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun61 & "','" & Nama_Akun61 & "','" & Kelompok_Akun61 & "','" & Tanggal_Input1 & "','" & Tahun61 & "','" & debet61 & "','" & kredit61 & "''" & header61 & "',)"

                'Sql62 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun62 & "','" & Nama_Akun62 & "','" & Kelompok_Akun62 & "','" & Tanggal_Input1 & "','" & Tahun62 & "','" & debet62 & "','" & kredit62 & "''" & header62 & "',)"

                'Sql63 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun63 & "','" & Nama_Akun63 & "','" & Kelompok_Akun63 & "','" & Tanggal_Input1 & "','" & Tahun63 & "','" & debet63 & "','" & kredit63 & "'" & header63 & "',')"

                'Sql64 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun64 & "','" & Nama_Akun64 & "','" & Kelompok_Akun64 & "','" & Tanggal_Input1 & "','" & Tahun64 & "','" & debet64 & "','" & kredit64 & "''" & header64 & "',)"

                Sql65 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun65 & "','" & Nama_Akun65 & "','" & Kelompok_Akun65 & "','" & Tahun65 & "','" & debet65 & "','" & kredit65 & "','" & header65 & "')"

                Sql66 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun66 & "','" & Nama_Akun66 & "','" & Kelompok_Akun66 & "','" & Tahun66 & "','" & debet66 & "','" & kredit66 & "','" & header66 & "')"




                Sql67 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
               " VALUES ('" & Nomor_Akun67 & "','" & Nama_Akun67 & "','" & Kelompok_Akun67 & "','" & Tahun67 & "','" & debet67 & "','" & kredit67 & "','" & header67 & "')"

                Sql68 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun68 & "','" & Nama_Akun68 & "','" & Kelompok_Akun68 & "','" & Tahun68 & "','" & debet68 & "','" & kredit68 & "','" & header68 & "')"

                Sql69 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun69 & "','" & Nama_Akun69 & "','" & Kelompok_Akun69 & "','" & Tahun69 & "','" & debet69 & "','" & kredit69 & "','" & header69 & "')"

                Sql70 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun70 & "','" & Nama_Akun70 & "','" & Kelompok_Akun70 & "','" & Tahun70 & "','" & debet70 & "','" & kredit70 & "','" & header70 & "')"

                Sql71 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun71 & "','" & Nama_Akun71 & "','" & Kelompok_Akun71 & "','" & Tahun71 & "','" & debet71 & "','" & kredit71 & "','" & header71 & "')"

                Sql72 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun72 & "','" & Nama_Akun72 & "','" & Kelompok_Akun72 & "','" & Tahun72 & "','" & debet72 & "','" & kredit72 & "','" & header72 & "')"

                Sql73 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun73 & "','" & Nama_Akun73 & "','" & Kelompok_Akun73 & "','" & Tahun73 & "','" & debet73 & "','" & kredit73 & "','" & header73 & "')"

                'Sql74 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tanggal_Input, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                '" VALUES ('" & Nomor_Akun74 & "','" & Nama_Akun74 & "','" & Kelompok_Akun74 & "','" & Tanggal_Input1 & "','" & Tahun74 & "','" & debet74 & "','" & kredit74 & "','" & header74 & "')"

                Sql75 = "INSERT INTO Table_Akun2(Nomor_Akun, Nama_Akun, Kelompok_Akun, Tahun, Saldo_Debet, Saldo_Kredit, header)" & _
                " VALUES ('" & Nomor_Akun75 & "','" & Nama_Akun75 & "','" & Kelompok_Akun75 & "','" & Tahun75 & "','" & debet75 & "','" & kredit75 & "','" & header75 & "')"
                ...
                'LapPosisiKeuangan.CrystalReportViewer1.SelectionFormula = "{Table_Akun.Tanggal_Input} in date ('" & CDate(Format(DateTimePicker1.Value, "yyyy-MM-dd")) & "') TO DateValue ('" & CDate(Format(DateTimePicker2.Value, "yyyy-MM-dd")) & "')"
                '{Table_Akun.Bulan}='" & bln & "' AND 
                'LapPosisiKeuangan.CrystalReportViewer1.SelectionFormula = "{Table_Akun.Tahun}='" & txtTahun.Text & "'"

                'LapAktivitas.CrystalReportViewer1.SelectionFormula = "{Table_Akun.Kode_Neraca} = '1'"
                'LapPosisiKeuangan.CrystalReportViewer1.SelectionFormula = "{Table_Akun.Kode_Neraca} =1"
                ...
                'crPFD2 = crPFDs.Item("debet1")
                'crPFD3 = crPFDs.Item("debet1")
                ...
                LapPosisiKeuangan.CrystalReportViewer1.ReportSource = rep
                'LapAktivitas.CrystalReportViewer1.RefreshReport()
                'LapAktivitas.CrystalReportViewer1.Refresh()
