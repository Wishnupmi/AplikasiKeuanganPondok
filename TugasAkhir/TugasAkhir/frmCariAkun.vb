...
Public Class frmCariAkun
    ...
    Public Kd_Akun, Nm_Akun, saldodebet, saldokredit, debit, kredit As String
    ...
    Private Sub tampil2()
        ...
        Sql = "SELECT * From Table_Akun WHERE Nama_Akun like '%" + Trim(txtCariAkun.Text) + "%' AND Header = '2' And Bulan='" & CStr(Bln) & "' And Tahun='" & CStr(Thn) & "' Order by Nomor_Akun asc"
    ...
    Private Sub tampil()
        ...
        'NomorAgenda()
        'Where Nama_Akun like '" & txtCariAkun.Text & "'
        Sql = "SELECT * From Table_Akun WHERE Header = '2' And Bulan='" & CStr(Bln) & "' And Tahun='" & CStr(Thn) & "' Order by Nomor_Akun asc"
    ...
    Private Sub DataGridView1_ColumnDividerWidthChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles DataGridView1.ColumnDividerWidthChanged
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        ...
        With DataGridView1.Rows.Item(i)
            ...
            Nm_Akun = .Cells(2).Value
            saldodebet = .Cells(5).Value
            saldokredit = .Cells(6).Value
            'debit = .Cells(8).Value
            'kredit = .Cells(9).Value
        ...
        'frmInputTransaksi.Visible = True
        Me.Hide()
        ...
        'frmInputTransaksi.Hide()
        'frmInputTransaksi.Show()
        frmInputTransaksi.txtNoAkun.Text = Kd_Akun.ToString
        frmInputTransaksi.txtNmAkun.Text = Nm_Akun.ToString

        If CStr(saldodebet.ToString) <> "0" Then
            saldodebet = saldodebet.ToString

        Else
            saldodebet = saldokredit.ToString

            'MsgBox(saldokredit)
        End If

        If frmInputTransaksi.cmbJnsTransaksi.Text = "Transaksi Kas Masuk" Then
            frmInputTransaksi.txtSaldo.Text = saldodebet
            'frmInputTransaksi.txtDebetKredit.Text = debit.ToString
        ElseIf frmInputTransaksi.cmbJnsTransaksi.Text = "Transaksi Kas Keluar" Then
            frmInputTransaksi.txtSaldo.Text = saldodebet
            'frmInputTransaksi.txtDebetKredit.Text = kredit.ToString
        Else
            MsgBox("Pilih Jenis Transaksi")
        End If
